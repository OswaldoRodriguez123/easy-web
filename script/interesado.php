			...
			<tr>
                                ...
                                <td valign="top">
                                  <font style="font-family:HelveticaNeue,Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#000000">
                                    Hola <b> '.$nombre.' '.$apellido.' </b> estamos muy contentos que te hayas unido a nuestra comunidad del baile, tu cuenta de <b> '.$academia.' </b> ha sido creada, ahora sólo debes pulsar el enlace  para la verificación tu correo.</font>
                                </td>
                              </tr>
