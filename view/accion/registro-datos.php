    ...
    <div class="container" ng-init="confirmado=false;sinconfirmar=false;" >
		<div class="row">
			...
			<div class="col-lg-10" ng-show="confirmado" >
				...
				<p class="text-center">te estamos redirecionado a la aplicación de <a href="http://app.easydancelatino.com" >Easy Dance</a></p>
			...
			<div class="col-lg-10" ng-show="sinconfirmar">
				...
				<hr>	
				<div class="text-center">
					<a href="#/ponte-en-accion/prueba-gratis" class="btn btn-violeta btn-lg text-center" >Registrate</a>
				</div>
                <!--<h2 class="text-center tam-3">Espéralo 2016</h2>-->
