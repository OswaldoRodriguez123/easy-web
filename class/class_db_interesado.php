   ...
   class DBInteresado extends Conexion{
      ...
      //------------------------------------------------------------------------------------------------------------
		public function agregar($data){
            ...
            //$sentencia=array();
			if (!($sentencia = $this->mysqli->prepare('INSERT INTO interesados(id,correo,clave,nombre,apellido,telefono,cargo,academia,direccion,telefono_local,telefono_movil,pais,estado,enteraste,status,fecha_de_registro) VALUES (NULL,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())'))){
				 //echo "Falló la preparación: (" . $this->mysqli->errno . ") " . $this->mysqli->error;
				 return "2";
			}
			/* Sentencia preparada, etapa 2: vinculación y ejecución */
			if (!$sentencia->bind_param("ssssssssssissi",$correo,$clave,$nombre,$apellido,$telefono,$cargo,$academia,$direccion,$telefono_local,$telefono_movil,$pais,$estado,$enteraste,$status)){
